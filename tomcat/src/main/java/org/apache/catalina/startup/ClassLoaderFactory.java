...
public final class ClassLoaderFactory {
	...
	/**
	 * Create and return a new class loader, based on the configuration defaults and
	 ...
	 *                 <code>null</code> for no unpacked directories to be
	 *                 considered
	 ...
	 * the specified directory paths:
	 *
	 * @param repositories List of class directories, jar files, jar directories or
	 *                     URLS that should be added to the repositories of the
	 *                     class loader.
	 * @param parent       Parent class loader for the new class loader, or
	 *                     <code>null</code> for the system class loader.
	 *
