...
public class StandardEngine extends ContainerBase implements Engine {
	...
	/**
	 * Host name to use when no server host, or an unknown host, is specified in the
	 * request.
	 */
	...
	/**
	 * Default access log to use for request/response pairs where we can't ID the
	 * intended host and context.
	 */
	...
	/**
	 * Obtain the configured Realm and provide a default Realm implementation when
	 * no explicit configuration is set.
	 *
	...
	/**
	 * Set the cluster-wide unique identifier for this Engine. This value is only
	 * useful in a load-balancing scenario.
	 * <p>
	...
	/**
	 * Retrieve the cluster-wide unique identifier for this Engine. This value is
	...
	/**
	 * Disallow any attempt to set a parent for this Container, since an Engine is
	 * supposed to be at the top of the Container hierarchy.
	 *
	 ...
	 * Engine, look for one in the Engine's default host and then the default host's
	 * ROOT context. If still none is found, return the default NoOp access log.
	 */
	@Override
