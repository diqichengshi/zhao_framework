...
public abstract class AbstractEndpoint {
	...
	/**
	 * Allows the server developer to specify the backlog that should be used for
	 * server sockets. By default, this value is 100.
	 */
	 ...
	 * sub-component is the {@link org.apache.tomcat.util.net.ServerSocketFactory}.
	 */
